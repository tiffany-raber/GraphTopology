...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private bool rotLocked;
        ...
        private void FixedUpdate()
        {
            ...
            if (m_CharacterController.enabled) m_CollisionFlags = m_CharacterController.Move(m_MoveDir * Time.fixedDeltaTime);
                
            if (!rotLocked) RotateView();
